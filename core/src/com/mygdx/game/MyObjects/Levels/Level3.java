...
public class Level3 implements Screen, Level{
    ...
    private int[] countMonsters = {7, 8, 12, 12, 9, 3, 20, 5, 6, 10};

    public Level3(int countLifes) {
    ...
    public void InsertWaves() {
        wavesMonsterTypes.put(0, new String[]{"grant"});
        wavesMonsterTypes.put(1, new String[]{"grant", "ogre"});
        wavesMonsterTypes.put(2, new String[]{"peon", "grant"});
        wavesMonsterTypes.put(3, new String[]{"grant", "ogre"});
        wavesMonsterTypes.put(4, new String[]{"grant", "bomber", "troll"});
        wavesMonsterTypes.put(5, new String[]{"dragonLow", "demon"});
        ...
        wavesMonsterTypes.put(9, new String[]{"dragonLow", "dragon", "demon"});
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.batch.draw(Loader.GetLevelFon(3), 0, 0, 800, 480);
        for (Monster enemy: Monster.currentEnemys)
            enemy.Draw();
        ...
        game.batch.draw(base, 215, 385, 100, 100);
    ...
    public void TowersSpawn() {
        ...
        int[] ordinations = new int[]{90, 155, 240, 155, 390, 155, 540, 155, 350, 370, 490, 370, 640, 370};
